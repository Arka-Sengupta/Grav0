...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(e,t,n){let r=new Float32Array(go),i=new q(0,1,0);return new Ji({name:`SphericalGaussianBlur`,defines:{n:go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:No(),fragmentShader:`
	...
	`}var Po=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Ni([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,ru=class{constructor(e){this.scene=e,this.time=0,this._bodyData=Array(64).fill(null).map(()=>new Ut(0,0,0,0));let t=new Ri(Zl,Zl,Ql,Ql);this.material=new Ji({uniforms:{uBodies:{value:this._bodyData},uNumBodies:{value:0},uG:{value:Vl},uMaxDepth:{value:$l},uSoftening:{value:eu},uTime:{value:0},uScale:{value:1}},vertexShader:tu,fragmentShader:nu,transparent:!0,side:2,depthWrite:!1}),this.mesh=new mi(t,this.material),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=-.5,e.add(this.mesh)}update(e,t,n,r){if(this.time+=t,this.material.uniforms.uTime.value=this.time,this.material.uniforms.uNumBodies.value=e.length,n&&r){let e=n.position.distanceTo(r),t=Math.max(.5,e/20);this.mesh.scale.set(t,t,1),this.material.uniforms.uScale.value=t,this.mesh.position.x=r.x,this.mesh.position.z=r.z}for(let t=0;t<64;t++)if(t<e.length){let n=e[t];this._bodyData[t].set(n.pos[0],n.pos[1],0,n.mass)}else this._bodyData[t].set(0,0,0,0)}},iu=0;function au(e){return e>=1e6?.35+Math.log10(e/Wl+1)*.25:e>=20?.45:e>=2?.32:e>=.5?.25:e>=.08?.18:.14}var ou=180,su=class{constructor(e,t){this.positions=new Float32Array(ou*3),this.alphas=new Float32Array(ou),this._head=0,this._filled=0;let n=new Er;n.setAttribute(`position`,new dr(this.positions,3)),n.setAttribute(`alpha`,new dr(this.alphas,1)),n.setDrawRange(0,0),this.points=new ji(n,new Ji({uniforms:{uColor:{value:new X(t)}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:2})),this.geo=n,e.add(this.points)}push(e,t,n){let r=this._head;this.positions[r*3]=e,this.positions[r*3+1]=t,this.positions[r*3+2]=n,this._head=(this._head+1)%ou,this._filled<ou&&this._filled++;for(let e=0;e<this._filled;e++){let t=(this._head-1-e+ou)%ou;this.alphas[t]=1-e/this._filled}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.alpha.needsUpdate=!0,this.geo.setDrawRange(0,this._filled)}dispose(e){e.remove(this.points),this.geo.dispose(),this.points.material.dispose()}},cu=class{constructor(e){this.scene=e,this._meshMap=new Map,this._frameCounter=0,this.onChanged=null}createBody(e){let t=++iu,n=e.mass,r=[...e.pos??[0,0,0]],i=[...e.vel??[0,0,0]],a={id:t,mass:n,radius:e.radius??1,pos:r,vel:i};return n>=1e6?this._createBlackHoleMesh(a):this._createStarMesh(a),this.onChanged&&this.onChanged(),a}_toWorld(e){return[e[0],e[2],e[1]]}_createStarMesh(e){let t=au(e.mass),n=Kl(e.mass),r=ql(e.mass),i=Jl(e.mass),a=new mi(new zi(t,32,32),new Xi({color:new X(n),emissive:new X(r),emissiveIntensity:2,metalness:.15,roughness:.25})),o=this._toWorld(e.pos);a.position.set(...o),this.scene.add(a);let s=new Kr(new Mr({color:new X(i),transparent:!0,opacity:.18,depthWrite:!1,blending:2}));s.scale.setScalar(t*3.5),s.position.copy(a.position),this.scene.add(s);let c=new su(this.scene,i);this._meshMap.set(e.id,{sphere:a,glow:s,ring:null,trail:c})}_createBlackHoleMesh(e){let t=au(e.mass),n=new mi(new zi(t,48,48),new Xi({color:0,emissive:1114112,emissiveIntensity:.3,roughness:0,metalness:1})),r=this._toWorld(e.pos);n.position.set(...r),this.scene.add(n);let i=new mi(new Bi(t*2,t*.45,12,80),new ni({color:16733440,transparent:!0,opacity:.75,side:2,blending:2,depthWrite:!1}));i.position.copy(n.position),i.rotation.x=Math.PI*.28,i.rotation.z=Math.PI*.1,this.scene.add(i);let a=new mi(new Bi(t*1.25,t*.18,8,80),new ni({color:16763972,transparent:!0,opacity:.9,side:2,blending:2,depthWrite:!1}));a.position.copy(n.position),a.rotation.x=Math.PI*.28,a.rotation.z=Math.PI*.1,this.scene.add(a);let o=new Kr(new Mr({color:new X(16724736),transparent:!0,opacity:.35,depthWrite:!1,blending:2}));o.scale.setScalar(t*6),o.position.copy(n.position),this.scene.add(o),this._meshMap.set(e.id,{sphere:n,glow:o,ring:i,innerRing:a,trail:null})}updateMesh(e){let t=this._meshMap.get(e.id);if(!t)return;let{sphere:n,glow:r,ring:i,innerRing:a,trail:o}=t,[s,c,l]=this._toWorld(e.pos);if(n.position.set(s,c,l),n.rotation.y+=.012,n.rotation.z+=.004,r){r.position.copy(n.position);let t=performance.now()*.001;r.material.opacity=.12+Math.sin(t*2+e.id)*.06}i&&(i.position.copy(n.position),i.rotation.z+=.012),a&&(a.position.copy(n.position),a.rotation.z-=.02),this._frameCounter++,o&&this._frameCounter%3==0&&o.push(s,c,l)}removeBody(e){let t=this._meshMap.get(e.id);if(!t)return;let{sphere:n,glow:r,ring:i,innerRing:a,trail:o}=t,s=e=>{e&&(e.geometry?.dispose(),e.material?.dispose(),this.scene.remove(e))};s(n),s(r),s(i),s(a),o&&o.dispose(this.scene),this._meshMap.delete(e.id),this.onChanged&&this.onChanged()}removeAll(e){for(let t of e)this.removeBody(t)}highlightBody(e,t){let n=this._meshMap.get(e);n?.sphere&&(n.sphere.material.emissiveIntensity=t?5:2,n.glow&&(n.glow.material.opacity=t?.45:.18))}pick(e,t){let n=t.map(e=>{let t=this._meshMap.get(e.id);return t?{mesh:t.sphere,id:e.id}:null}).filter(Boolean),r=e.intersectObjects(n.map(e=>e.mesh));return r.length?n.find(e=>e.mesh===r[0].object)?.id??null:null}},lu=class{constructor(e,t,n){this.sim=e,this.bodyMgr=t,this.scene3d=n,this.selectedId=null,this._autoOrbit=!0,this._frameTimes=[],this._lastFrame=performance.now(),this._bind(),this._setupRaycasting(),this.updateGPUBadge(),this.updateBodyList([])}_calcOrbitalVelocity(e,t,n){let r=this.sim.bodies;if(r.length===0)return{vx:0,vy:0,vz:0,ref:null};let i=r[0];for(let e of r)e.mass>i.mass&&(i=e);let a=e-i.pos[0],o=t-i.pos[1],s=n-i.pos[2],c=Math.sqrt(a*a+o*o+s*s);if(c<1e-6)return{vx:0,vy:0,vz:0,ref:i};let l=Math.sqrt(Vl*i.mass/c),u=-o/c,d=a/c;return{vx:i.vel[0]+u*l,vy:i.vel[1]+d*l,vz:i.vel[2],ref:i,r:c,vOrbit:l}}_bind(){let e=document.getElementById(`btn-play`),t=document.getElementById(`time-scale`),n=document.getElementById(`time-label`);e.addEventListener(`click`,()=>{this.sim.paused=!this.sim.paused,e.textContent=this.sim.paused?`▶ Play`:`⏸ Pause`,e.classList.toggle(`active`,!this.sim.paused)}),t.addEventListener(`input`,()=>{let e=parseFloat(t.value);this.sim.timeScale=10**e;let r=this.sim.timeScale;n.textContent=r<1?`×${r.toFixed(2)}`:r<100?`×${r.toFixed(1)}`:`×${Math.round(r)}`}),document.getElementById(`add-body-form`).addEventListener(`submit`,e=>{e.preventDefault(),this._addBodyFromForm()});let r=document.getElementById(`btn-auto-orbit`);r.addEventListener(`click`,()=>{this._autoOrbit=!this._autoOrbit,r.classList.toggle(`active`,this._autoOrbit),r.textContent=this._autoOrbit?`🔄 Auto Orbit: ON`:`🔄 Auto Orbit: OFF`,this._updateOrbitPreview()}),[`input-px`,`input-py`,`input-pz`].forEach(e=>{document.getElementById(e).addEventListener(`input`,()=>this._updateOrbitPreview())}),document.getElementById(`preset-sun-earth`).addEventListener(`click`,()=>this._presetSunEarth()),document.getElementById(`preset-binary`).addEventListener(`click`,()=>this._presetBinary()),document.getElementById(`preset-blackhole`).addEventListener(`click`,()=>this._presetBlackHole()),document.getElementById(`btn-reset`).addEventListener(`click`,()=>this._dispatchClear());let i=document.getElementById(`input-mass`),a=document.getElementById(`mass-unit`),o=document.getElementById(`mass-preview`),s=()=>{let e=parseFloat(i.value)||0,t=a.value===`solar`?e:e/1989e27;o.textContent=Yl(t),o.className=t>=1e6?`mass-preview bh`:`mass-preview`};i.addEventListener(`input`,s),a.addEventListener(`change`,s)}_setupRaycasting(){let e=new Ya,t=new K;this.scene3d.renderer.domElement.addEventListener(`click`,n=>{if(n.target!==this.scene3d.renderer.domElement)return;t.x=n.clientX/window.innerWidth*2-1,t.y=-(n.clientY/window.innerHeight)*2+1,e.setFromCamera(t,this.scene3d.camera);let r=this.bodyMgr.pick(e,this.sim.bodies);this.selectedId!==null&&(this.bodyMgr.highlightBody(this.selectedId,!1),document.querySelector(`.body-item[data-id="${this.selectedId}"]`)?.classList.remove(`selected`)),r!==null&&r!==this.selectedId?(this.selectedId=r,this.bodyMgr.highlightBody(r,!0),document.querySelector(`.body-item[data-id="${r}"]`)?.classList.add(`selected`),this.onSelectBody&&this.onSelectBody(r)):this.selectedId=null})}_updateOrbitPreview(){let e=document.getElementById(`orbit-hint`);if(!e)return;if(!this._autoOrbit||this.sim.bodies.length===0){e.style.display=`none`;return}let t=parseFloat(document.getElementById(`input-px`).value)||0,n=parseFloat(document.getElementById(`input-py`).value)||0,r=parseFloat(document.getElementById(`input-pz`).value)||0,i=this._calcOrbitalVelocity(t,n,r);if(!i.ref){e.style.display=`none`;return}e.style.display=`block`,e.innerHTML=`
      <span class="orbit-icon">🔄</span>
      Orbiting <strong>${Yl(i.ref.mass)}</strong>
      at <strong>${i.r?.toFixed(2)} AU</strong><br>
      <span class="orbit-vel">v = ${i.vOrbit?.toFixed(2)} AU/yr auto-applied</span>
    `,document.getElementById(`input-vx`).value=i.vx.toFixed(4),document.getElementById(`input-vy`).value=i.vy.toFixed(4),document.getElementById(`input-vz`).value=i.vz.toFixed(4)}_addBodyFromForm(){let e=parseFloat(document.getElementById(`input-mass`).value),t=document.getElementById(`mass-unit`).value===`solar`?e:e/1989e27,n=parseFloat(document.getElementById(`input-px`).value)||0,r=parseFloat(document.getElementById(`input-py`).value)||0,i=parseFloat(document.getElementById(`input-pz`).value)||0;if(isNaN(t)||t<=0){this._flashError(`Enter a valid positive mass`);return}if(this.sim.bodies.length>=64){this._flashError(`Max 64 bodies`);return}let a=parseFloat(document.getElementById(`input-vx`).value)||0,o=parseFloat(document.getElementById(`input-vy`).value)||0,s=parseFloat(document.getElementById(`input-vz`).value)||0;if(this._autoOrbit&&this.sim.bodies.length>0){let e=this._calcOrbitalVelocity(n,r,i);a=e.vx,o=e.vy,s=e.vz}this._dispatchAddBody({mass:t,pos:[n,r,i],vel:[a,o,s]})}_flashError(e){let t=document.getElementById(`form-error`);t.textContent=e,t.style.opacity=`1`,clearTimeout(this._errTimer),this._errTimer=setTimeout(()=>{t.style.opacity=`0`},3e3)}_flashSuccess(e){let t=document.getElementById(`form-error`);t.textContent=e,t.style.color=`var(--accent-green)`,t.style.opacity=`1`,clearTimeout(this._errTimer),this._errTimer=setTimeout(()=>{t.style.opacity=`0`,t.style.color=``},2e3)}_dispatchAddBody(e){this.onAddBody&&this.onAddBody(e)}_dispatchClear(){this.onClear&&this.onClear()}_presetSunEarth(){this.onClear&&this.onClear(),setTimeout(()=>{this.onAddBody?.({mass:1,pos:[0,0,0],vel:[0,0,0]}),this.onAddBody?.({mass:3e-6,pos:[1,0,0],vel:[0,6.283,0]}),this.onAddBody?.({mass:95e-5,pos:[5.2,0,0],vel:[0,2.755,0]})},100)}_presetBinary(){this.onClear&&this.onClear(),setTimeout(()=>{this.onAddBody?.({mass:2,pos:[-1.5,0,0],vel:[0,-4.44,0]}),this.onAddBody?.({mass:2,pos:[1.5,0,0],vel:[0,4.44,0]})},100)}_presetBlackHole(){this.onClear&&this.onClear(),setTimeout(()=>{this.onAddBody?.({mass:1e7,pos:[0,0,0],vel:[0,0,0]}),this.onAddBody?.({mass:1e3,pos:[20,20,0],vel:[-2603.1701,2678.4409,0]})},100)}updateBodyList(e){let t=document.getElementById(`body-list`);if(t.innerHTML=``,e.length===0){t.innerHTML=`<div class="empty-hint">No bodies yet — use a preset or add below</div>`,this._updateOrbitPreview();return}for(let n of e){let e=n.mass>=Wl,r=document.createElement(`div`);r.className=`body-item`+(n.id===this.selectedId?` selected`:``),r.dataset.id=n.id;let i=Math.hypot(n.vel[0],n.vel[1],n.vel[2]).toFixed(2);r.innerHTML=`
        <div class="body-dot" style="background:${this._massHex(n.mass)}"></div>
        <div class="body-info">
          <span class="body-name">${e?`⚫ Black Hole`:`⭐ Body`} #${n.id}</span>
          <span class="body-detail">${Yl(n.mass)}</span>
          <span class="body-detail pos-detail">
            ${n.pos.map(e=>e.toFixed(2)).join(` , `)} AU
          </span>
          <span class="body-detail spd-detail">|v| = ${i} AU/yr</span>
        </div>
        <button class="btn-delete" data-id="${n.id}" title="Remove body">✕</button>
      `,r.querySelector(`.btn-delete`).addEventListener(`click`,e=>{e.stopPropagation(),this.onRemoveBody&&this.onRemoveBody(parseInt(e.currentTarget.dataset.id))}),r.addEventListener(`click`,()=>{this.onSelectBody&&this.onSelectBody(n.id)}),t.appendChild(r)}document.getElementById(`body-count`).textContent=e.length,document.getElementById(`body-count-max`).textContent=64,this._updateOrbitPreview()}_massHex(e){return e>=1e6?`#ff4400`:e>=20?`#88aaff`:e>=2?`#ffffff`:e>=.5?`#ffcc44`:e>=.08?`#ff8833`:`#cc4411`}updateFPS(){let e=performance.now(),t=e-this._lastFrame;this._lastFrame=e,this._frameTimes.push(t),this._frameTimes.length>60&&this._frameTimes.shift();let n=this._frameTimes.reduce((e,t)=>e+t,0)/this._frameTimes.length;document.getElementById(`fps-value`).textContent=Math.round(1e3/n)}updateGPUBadge(){let e=document.getElementById(`gpu-badge`);this.sim.useGPU?(e.textContent=`⚡ GPU`,e.className=`badge gpu`):(e.textContent=`🖥 CPU`,e.className=`badge cpu`)}},uu=new Bl(document.getElementById(`sim-canvas`)),du=new Xl(uu.renderer),fu=new ru(uu.scene),pu=new cu(uu.scene),mu=new lu(du,pu,uu);mu.onAddBody=e=>{let t=pu.createBody(e);if(!du.addBody(t)){pu.removeBody(t),mu._flashError(`Maximum bodies reached`);return}mu.updateBodyList(du.bodies)},mu.onRemoveBody=e=>{let t=du.bodies.find(t=>t.id===e);t&&(pu.removeBody(t),du.removeBody(e),mu.selectedId===e&&(mu.selectedId=null),mu.updateBodyList(du.bodies))},mu.onClear=()=>{pu.removeAll(du.bodies),du.clearBodies(),mu.selectedId=null,mu.updateBodyList([])},mu.onSelectBody=e=>{let t=du.bodies.find(t=>t.id===e);if(!t)return;let n=new q(t.pos[0],t.pos[2],t.pos[1]);uu.controls.target.lerp(n,.5)},pu.onChanged=()=>mu.updateBodyList(du.bodies);function hu(){requestAnimationFrame(hu),du.step();for(let e of du.bodies)pu.updateMesh(e);fu.update(du.bodies,.016,uu.camera,uu.controls.target),mu.updateFPS(),uu.render()}hu(),document.getElementById(`btn-toggle-panel`).addEventListener(`click`,()=>{document.getElementById(`side-panel`).classList.toggle(`hidden`)});